...
/** @type {(json: json) => Either<Error, undefined>} */
export const instantiateUndefined = (json) => {
  if (json === null) {
    return makeRight(undefined);
  } else {
    return makeLeft(new Error("invalid undefined format"));
  }
};

/** @type {(void_: undefined) => json} */
export const serializeUndefined = (_void) => null;
